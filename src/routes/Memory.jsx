  ...
  return (
    <div className="memory-page">
      ...
      <div className="comment-form">
        <h3>Envie seu comentario:</h3>
        <form onSubmit={handleSubmit}>
          <label>
            <input type="text" placeholder='Seu nome' onChange={(e) => setName(e.target.value)} value={name}/>
          </label>
          <label>
            <textarea placeholder='Seu comentario...' onChange={(e) => setText(e.target.value)} value={text}></textarea>
          </label>
      ...
      <div className="comments-container">
        ...
        {comments.length === 0 && <p>Não ha comentarios...</p>}
        {comments.length > 0 && (
